...
## Install ffmpeg.
apt-get update
apt-get install -y -qq make cmake git gcc-4.8 gfortran-4.8 cpp-4.8 g++-4.8 yasm autoconf automake nasm libtool vim augeas-tools augeas-lenses curl software-properties-common python-software-properties bison wget re2c lemon
